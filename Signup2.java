...
public class Signup2 extends JFrame implements ActionListener{
    ...
    Signup2(String formno){
        ...
        c1.setBounds(200, 80, 300, 30);
        add(c1);
        
        l3.setBounds(50, 130, 100, 30);
        add(l3);
        
        c2.setBounds(200, 130, 300, 30);
        add(c2);
        
        l4.setBounds(50, 180, 100, 30);
        add(l4);
        
        c3.setBounds(200, 180, 300, 30);
        add(c3);
        
        l5.setBounds(50, 230, 150, 30);
        add(l5);
        
        c4.setBounds(200, 230, 300, 30);
        add(c4);
        
        l11.setBounds(50, 280, 150, 30);
        add(l11);
        
        l6.setBounds(50, 330, 150, 30);
        add(l6);
        
        c5.setBounds(200, 330, 300, 30);
        add(c5);
        
        l7.setBounds(50, 380, 150, 30);
        add(l7);
        
        t1.setBounds(200, 380, 300, 30);
        add(t1);
        
        l8.setBounds(50, 430, 150, 30);
        add(l8);
        
        t2.setBounds(200, 430, 300, 30);
        add(t2);
        
        l9.setBounds(50, 480, 150, 30);
        add(l9);
        
        r1.setBounds(200, 480, 100, 30);
        add(r1);
        
        r2.setBounds(320, 480, 100, 30);
        add(r2);
        
        l10.setBounds(50, 530, 150, 30);
        add(l10);
        
        r3.setBounds(200, 530, 100, 30);
        add(r3);
        
        r4.setBounds(320, 530, 100, 30);
        add(r4);
