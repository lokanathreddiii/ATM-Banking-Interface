...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(String formno){
        ...
        l11.setBounds(580, 10, 70, 30);
        add(l11);
        
        l12.setBounds(660, 10, 80, 30);
        add(l12);
        
        l1.setBounds(200, 40, 300, 30);
        add(l1); 
        
        l2.setBounds(50, 100, 200, 30);
        add(l2);
        
        r1.setBounds(50, 140, 150, 30);
        add(r1);
        
        r2.setBounds(230, 140, 200, 30);
        add(r2);
        
        r3.setBounds(50, 180, 200, 30);
        add(r3);
        
        r4.setBounds(230, 180, 250, 30);
        add(r4);
        
        l3.setBounds(50, 240, 200, 30);
        add(l3);
        
        l4.setBounds(250, 240, 250, 30);
        add(l4);
        
        l5.setBounds(50, 270, 200, 20);
        add(l5);
        
        l6.setBounds(250, 270, 400, 20);
        add(l6);
        
        l7.setBounds(50, 300, 200, 30);
        add(l7);
        
        l8.setBounds(250, 300, 200, 30);
        add(l8);
        
        l9.setBounds(50, 330, 200, 20);
        add(l9);
        
        l10.setBounds(50, 360, 200, 30);
        add(l10);
        
        c1.setBounds(50, 400, 200, 30);
        add(c1);
        
        c2.setBounds(250, 400, 200, 30);
        add(c2);
        
        c3.setBounds(50, 440, 200, 30);
        add(c3);
        
        c4.setBounds(250, 440, 200, 30);
        add(c4);
        
        c5.setBounds(50, 480, 200, 30);
        add(c5);
        
        c6.setBounds(250, 480, 200, 30);
        add(c6);
        
        c7.setBounds(50, 540, 500, 20);
        add(c7);
